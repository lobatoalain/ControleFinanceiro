...
namespace ControleFinanceiro.Controllers
{
    public class ReceitasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome")] Receita receita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome")] Receita receita)
        {
            if (id != receita.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ControleFinanceiroContext.Receita'  is null.");
            }
            var receita = await _context.Receita.FindAsync(id);
            if (receita != null)
            {
